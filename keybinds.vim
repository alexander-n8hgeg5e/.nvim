...
\ '<S+F3>___!___ExMode'    :  [ '*@', '<Cmd>call Win_ExMode_HeightDown()<CR>' ],
\ '<F22>___!___ExMode'     :  [ '*@', '<Cmd>call Win_ExMode_HeightUp()<CR>' ],
\ '<S+F10>___!___ExMode'   :  [ '*@', '<Cmd>call Win_ExMode_HeightUp()<CR>' ],
\ '<F22>___ ___ExMode'     :  [ '*@', '<Cmd>call Win_ExMode_HeightUp()<CR> ' ],
\ '<S+F10>___ ___ExMode'   :  [ '*@', '<Cmd>call Win_ExMode_HeightUp()<CR> ' ],
\ '<F15>___ ___ExMode'     :  [ '*@', '<Cmd>call Win_ExMode_HeightDown()<CR>' ],
\ '<S+F3>___ ___ExMode'    :  [ '*@', '<Cmd>call Win_ExMode_HeightDown()<CR>' ],
...
\ '<S+F6>___v___Common'         : [    '*',       'c#<Esc>' ],
\ '<F18>___n___Common'         : [    '*',       '<C-v>c#<Esc>' ],
\ '<S+F6>___n___Common'         : [    '*',       '<C-v>c#<Esc>' ],
...
\ '<S+F10>___t___Common'         : [    '*',       '<C-\><C-N><Cmd>call WinHeightUp()<CR>a' ],
...
\ '<F19>___!___Common'         : [    '*',       'z=' ],
\ '<S+F7>___!___Common'         : [    '*',       'z=' ],
\ '<F17>___!___Common'         : [    '*',       'z=' ],
\ '<S+F5>___!___Common'         : [    '*',       'z=' ],
...
\ '<S+F10>___!___Common'         : [    '*',       '<Cmd>call WinHeightUp()<CR>' ],
...
\ '<S-F4>___ ___Common'        : [    '*',       '<Cmd>call WinWidthR()<CR>' ],
...
\ '<S-F2>___!___Common'        : [    '*',       '<Cmd>call WinWidthL()<CR>a' ],
\ '<F15>___ ___Common'         : [    '*',       '<Cmd>call WinHeightDown()<CR>' ],
\ '<S-F3>___ ___Common'        : [    '*',       '<Cmd>call WinHeightDown()<CR>' ],
...
\ '<S-F3>___t___Common'        : [    '*',       '<C-\><C-N><Cmd>call WinHeightDown()<CR>a' ],
...
\ '<S-F10>___ ___Common'       : [    '*',       '<Cmd>call WinHeightUp()<CR><Space>' ],
...
\ '<S-F4>___t___Common'        : [    '*',       '<C-\><C-N><Cmd>call WinWidthR()<CR>a' ],
\ '<M-b>___n___Common'         : [    ' ',       '<Cmd>call OpenBrowser()<CR>' ],
\ 'd___ ___Common'             : [    '*',       'jjjj' ],
\ 'd___n___Common'             : [    '*',       'jjjj' ],
\ '<F14>___t___Common'         : [    '*',       '<C-\><C-N><Cmd>call WinWidthL()<CR>a' ],
\ '<S+F2>___t___Common'        : [    '*',       '<C-\><C-N><Cmd>call WinWidthL()<CR>a' ],
\ '<F14>___ ___Common'         : [    '*',       '<Cmd>call WinWidthL()<CR>' ],
\ '<S+F2>___ ___Common'        : [    '*',       '<Cmd>call WinWidthL()<CR>' ],
...
\ '<S+F4>___!___Common'        : [    '*',       '<Cmd>call WinWidthR()<CR>a' ],
...
\ '<S+F10>___ ___DefaultMode'  : [    '*',       '<Cmd>call WinHeightUp()<CR>' ],
\ '<F15>___ ___DefaultMode'    : [    '*',       '<Cmd>call WinHeightDown()<CR>' ],
\ '<S+F3>___ ___DefaultMode'   : [    '*',       '<Cmd>call WinHeightDown()<CR>' ],
\ '<F14>___ ___DefaultMode'    : [    '*',       '<Cmd>call WinWidthL()<CR>' ],
\ '<S+F2>___ ___DefaultMode'   : [    '*',       '<Cmd>call WinWidthL()<CR>' ],
\ '<F16>___ ___DefaultMode'    : [    '*',       '<Cmd>call WinWidthR()<CR>' ],
\ '<S+F4>___ ___DefaultMode'   : [    '*',       '<Cmd>call WinWidthR()<CR>' ],
\ '<F22>___!___DefaultMode'    : [    '*',       '<Cmd>call WinHeightUp()<CR>a' ],
\ '<S+F10>___!___DefaultMode'  : [    '*',       '<Cmd>call WinHeightUp()<CR>a' ],
\ '<F15>___!___DefaultMode'    : [    '*',       '<Cmd>call WinHeightDown()<CR>a' ],
\ '<S+F3>___!___DefaultMode'   : [    '*',       '<Cmd>call WinHeightDown()<CR>a' ],
\ '<F16>___!___DefaultMode'    : [    '*',       '<Cmd>call WinWidthR()<CR>a' ],
\ '<S+F4>___!___DefaultMode'   : [    '*',       '<Cmd>call WinWidthR()<CR>a' ],
\ '<F14>___!___DefaultMode'    : [    '*',       '<Cmd>call WinWidthL()<CR>a' ],
\ '<S+F2>___!___DefaultMode'   : [    '*',       '<Cmd>call WinWidthL()<CR>a' ],
\ '<F22>___t___DefaultMode'    : [    '*',       '<Cmd>call WinHeightUp()<CR>a' ],
\ '<S+F10>___t___DefaultMode'  : [    '*',       '<Cmd>call WinHeightUp()<CR>a' ],
\ '<F15>___t___DefaultMode'    : [    '*',       '<Cmd>call WinHeightDown()<CR>a' ],
\ '<S+F3>___t___DefaultMode'   : [    '*',       '<Cmd>call WinHeightDown()<CR>a' ],
\ '<F16>___t___DefaultMode'    : [    '*',       '<Cmd>call WinWidthR()<CR>a' ],
\ '<S+F4>___t___DefaultMode'   : [    '*',       '<Cmd>call WinWidthR()<CR>a' ],
\ '<F14>___t___DefaultMode'    : [    '*',       '<Cmd>call WinWidthL()<CR>a' ],
\ '<S+F2>___t___DefaultMode'   : [    '*',       '<Cmd>call WinWidthL()<CR>a' ],
