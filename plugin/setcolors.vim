...
function! s:SetColors(args)
  ...
  elseif a:args == 'config'
    let g:mycolors = g:mycolors
    echo 'list of colors set from var: g:mycolors'
  elseif a:args == 'now'
    call s:HourColor()
  else
...
function! s:HourColor()
  ...
  let nowcolors = 'vividchalk tender simpleandfriendly gentooishmod darkZ'
  execute 'colorscheme '.split(nowcolors)[i]
  redraw
  echo g:colors_name
endfunction

command!  HourColor call s:HourColor()
