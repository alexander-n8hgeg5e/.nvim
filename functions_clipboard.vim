let s:f1=        "function! ClipboardWrite_s(lines,regtype)\n"
let s:f1= s:f1.  "    py3 pwp.run_pycode(pycode[\"clipboard_update_xorg_s\"][\"code\"])\n"
let s:f1= s:f1.  "endfunction"
exe s:f1

let s:f1=        "function! ClipboardWrite_p(lines,regtype)\n"
...
let s:f1= s:f1.  "    py3 pwp.run_pycode(pycode[\"clipboard_update_xorg_p\"][\"code\"])\n"
...
let s:f2 =        "function! ClipboardRead_p()\n"
...
let s:f2 =        "function! ClipboardRead_s()\n"
let s:f2 = s:f2 . "    let lines =   system(['xclip','-o','-selection','primary' ])\n"
let s:f2 = s:f2 . "    let regtype = ''\n"
let s:f2 = s:f2 . '    return [split(lines,''\n'') , regtype ]'."\n"
let s:f2 = s:f2 . "endfunction\n"
exe s:f2
