...
if has('gui_running')
    ...
    hi ErrorMsg       term=standout ctermfg=231 ctermbg=95
    hi IncSearch      term=reverse ctermfg=16 ctermbg=202
    hi Search         term=reverse ctermfg=231 ctermbg=95
    hi MoreMsg        term=bold ctermfg=231
    hi ModeMsg        term=bold ctermfg=231
    hi LineNr         term=underline ctermfg=250 ctermbg=235
    hi Question       term=standout ctermfg=231
    hi StatusLine     term=bold,reverse cterm=bold ctermfg=231 ctermbg=236
    hi StatusLineNC   term=reverse cterm=bold ctermfg=240 ctermbg=236
    hi VertSplit      term=reverse ctermfg=231 ctermbg=236
    hi Title          term=bold ctermfg=95
    hi Visual         term=reverse ctermfg=231 ctermbg=60
    hi VisualNOS      term=bold,underline ctermfg=231 ctermbg=16
    hi WarningMsg     term=standout ctermfg=231 ctermbg=95
    hi WildMenu       term=standout cterm=bold ctermfg=177 ctermbg=16
    hi Folded         term=standout ctermfg=142 ctermbg=16
    hi FoldColumn     term=standout ctermfg=231 ctermbg=16
    hi DiffAdd        term=bold ctermfg=231 ctermbg=59
    hi DiffChange     term=bold ctermbg=54
    hi DiffDelete     term=bold ctermfg=231 ctermbg=95
    ...
    hi Comment        term=bold ctermfg=40
    ...
    hi Underlined     term=underline cterm=underline ctermfg=231
    hi Ignore         ctermfg=240
    hi Todo           term=standout ctermfg=231 ctermbg=95
    hi String         ctermfg=85 ctermbg=233
    ...
    hi Statement      term=bold ctermfg=77
    hi PreProc        term=underline ctermfg=95
    hi Type           term=underline ctermfg=60
    hi Underlined     term=underline cterm=underline ctermfg=231
    hi Ignore         ctermfg=240
    ...
    if v:version >= 700
        ...
        hi PmenuSbar      ctermfg=231 ctermbg=16
        hi PmenuThumb     ctermfg=231 ctermbg=236
