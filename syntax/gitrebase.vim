...
syn match   gitrebaseCommit "\v<\x{7,}>"     nextgroup=gitrebaseFiles skipwhite
syn match   gitrebaseFiles  "\v[ ][[][^]]*[]]"  nextgroup=gitrebaseSummary skipwhite
...
hi def link gitrebaseFiles          Conditional
